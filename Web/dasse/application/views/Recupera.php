...
<section>
  <article>
    <form method="post" class="pure-steps" action="<?php echo base_url('index.php/Signs_Controller/rec'); ?>">
      ...
      <div class="pure-steps_group">
        <ol>
          <li class="pure-steps_group-step">
            <legend class="pure-steps_group-step_legend">Recuperar Password</legend>
            <p class="pure-steps_group-step_item flexy-item flexy-column reverse">
                <input type="email" placeholder="Inserir Email" value="<?php echo set_value('email')?>" name="email" id="input_email" required>
                <label for="input_email"> Email</label>
                </p> 
                <div style="margin-left:11%"><?php echo '<label class="a-field__label-wrap">' .$this->session->flashdata("error"). '</label>'; ?><div> 
                <div><?php echo '<label class="a-field__label-wrap">' .$this->session->flashdata("error1"). '</label>'; ?><div> 
                <div><?php echo '<label class="a-field__label-wrap">' .$this->session->flashdata("error2"). '</label>'; ?><div>             
          </li>
          ...
          <li class="pure-steps_group-step flexy-item">
            <div class="pure-steps_preload">
              ...
              <h6 style="margin-top: 10px">Vai ser enviado um email para recuperar a sua password!</h6>
              <h6>Clique no botão "Enviar Email"!</h6>
        ...
        <ol class="pure-steps_group-triggers">
          ...
          <li class="pure-steps_group-triggers_item">
          <label for="step-2" >Seguinte</label>
          </li>
        </ol>
      </div>
      <br>
