...
<div class="panels">
	...
	<div class="panel">
		<header class="panel__header">
			<h2 class="panel__title">Crie Conta para o seu 1º funcionário</h2>
		</header>
			<div class="page">
  				<div class="page__demo">
				  <form method="post" action="<?php echo base_url('index.php/RegEmpresaC/AdicionarF'); ?>">
				  
				  	<input type="hidden" class="field__input a-field__input" name="idE" value="<?php echo set_value('idE')?>" placeholder="ex: ID X" readonly>

    				<label class="field a-field a-field_a1 page__field">
      					<input class="field__input a-field__input" placeholder="ex: João" name="nomeF" required>
      						<span class="a-field__label-wrap">
        						<span class="a-field__label">Primeiro Nome *</span>
      						</span>
    				</label>
    				<label class="field a-field a-field_a1 page__field">
      					<input class="field__input a-field__input" placeholder="ex: Pereira" name="unomeF" required>
      						<span class="a-field__label-wrap">
        						<span class="a-field__label">Último Nome *</span>
      						</span>
    				</label>
    				<label class="field a-field a-field_a2 page__field">
      					<input type="number" pattern="[0-9] {9}" class="field__input a-field__input" name="teleF" placeholder="ex: 232231231" required>
      						<span class="a-field__label-wrap">
        						<span class="a-field__label">Telefone *</span>
      						</span>
    				</label>    
    				<label class="field a-field a-field_a3 page__field">
      						<input type="email" class="field__input a-field__input" name="emailF" placeholder="ex: empresa@exmpl.com" required>
      							<span class="a-field__label-wrap">
        							<span class="a-field__label">E-mail *</span>
      							</span>
    				</label>
    				<label class="field a-field a-field_a4 page__field">
      					<input type="text" pattern="^\d{4}(-\d{3})?$" name="codF" class="field__input a-field__input" placeholder="ex: 0000-000" required>
      						<span class="a-field__label-wrap">
        						<span class="a-field__label">Código Postal *</span>
     						</span>
    				</label>
    				<label class="field a-field a-field_a7 page__field" id="rest">
      					<input class="field__input a-field__input" id="morada" name="moradaF" placeholder="ex: Rua XXXXXX" required>
      						<span class="a-field__label-wrap">
    				...
    				<label class="field a-field a-field_a5 page__field">
      					<input type="password" maxlength="8"  name="passF" class="field__input a-field__input" placeholder="ex: QWER" required>
      						<span class="a-field__label-wrap">
        						<span class="a-field__label">Password *</span>
     						</span>
    				</label>
    				<label class="field a-field a-field_a6 page__field">
      					<input type="password" maxlength="8"   name="rpassF" class="field__input a-field__input" required>
						  <span class="a-field__label-wrap">
      						<span class="a-field__label">Repetir *</span>
						  </span>
    				</label>
   						<div class="container">
							<div class="row">
								...
								<br>
        							...
        							<div class="col-sm-12">
            							<select name="country" class="custom-select" id="FuncLoc" required>
                								<option value="">
...
<button class="button" type="submit" style="margin-top:30px; margin-left:20px">Concluir</button>
		<div>
			<?php
				echo '<label class="a-field__label-wrap">' .$this->session->flashdata("error3"). '</label>';
				echo '<label class="a-field__label-wrap">' .$this->session->flashdata("error4"). '</label>';
			?>
		</div>
  		</form>
	</div>
