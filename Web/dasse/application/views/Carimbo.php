...
<form method="post" action="<?php echo site_url('/Carimbo_Controller/carimbo'); ?>">
  <button class="btn btn-success btn-group" type="submit" name="Guardar" style="margin-left:1%; margin-top:1%;" > Ver Carimbos</button>
</form>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
               <form method="post" action="<?php echo site_url('/Carimbo_Controller/AdicionarCarimbo'); ?>" enctype="multipart/form-data">
                <h5 class="title"> <button class="btn btn-success btn-group" type="submit" name="Guardar" style=" float: right;"> Criar</button> Criar Carimbo</h5>
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label>Titulo do Carimbo</label>
                        <input type="text" name="TituloCarimbo" class="form-control" placeholder="Titulo" id="tC" onkeyup="titUFunction()" onkeydown="titDFunction()" requiredo>
</div>
</div>
<div class="col-md-4 pr-1">
<div class="form-group">
<label>Selecionar cor do texto</label>
<input id="changeff" type="text" class="form-control" name="corCarimbo"  class="gg"/>
</div>
</div>
</div>
                  ...
                  <div class="col-md-8 pr-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Prémio Carimbo</label>
                        <input type="text" name="Pcarimbo" class="form-control" placeholder="Prémio Carimbo" id="vC" required>
                      </div>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Data de Inicio do Carimbo (yyyy-mm-dd)</label>
                        <input type="data" name="DataInicioCarimbo" class="form-control" placeholder="Data de inicio do Carimbo" id="datepicker_put" onchange="dIUFunction()" required>
                      </div>
                    </div>
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Data de Fim do Carimbo (yyyy-mm-dd)</label>
                        <input type="data" name="DataFimCarimbo" class="form-control" placeholder="Data de fim do Carimbo" id="datepicker_get"  onchange ="dFUFunction()"required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Descrição do Carimbo</label>
                        <textarea type="text" name="DescricaoCarimbo" class="form-control" placeholder="Descrição do Carimbo" id="desC"  onkeyup="desCUFunction()" onkeydown="desCDFunction()" required></textarea>
...
<label style="margin-left: 7px">Imagem Predefinidas</label><br><div class="form-check form-check-inline">
